...
yellow "Customer Service is allowed to decode the last-four digits for identity verification purposes"
pe "vault write transform/decode/customer-service/last-four value=\"$ENCODED_SSN\" transformation=us-ssn"

yellow "Customer Service is not allowed to encode or fully decode SSNs"
